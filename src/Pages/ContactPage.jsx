        ...
        >
          {actions.map(({ label, icon: Icon, href, bg, text, border, glow, external }) => (
            ...
            >
              ...
              {label === "WhatsApp"?
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-whatsapp h-auto w-5" viewBox="0 0 16 16">
                ...
                </svg>:<Icon size={16} strokeWidth={2.2} />}
              {label}
            </motion.a>
          ))}
        </motion.div>
